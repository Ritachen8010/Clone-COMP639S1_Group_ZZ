...
(1, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(2, 'Monthly', '2023-05-01', '2023-05-31', 60.00),
(3, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(4, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(5, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(6, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(7, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(8, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(9, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(10, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(11, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(12, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(13, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(14, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(15, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(16, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(17, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(18, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(19, 'Annual', '2023-05-01', '2024-04-30', 700.00),
(20, 'Monthly', '2023-05-01', '2023-05-31', 60.00);
...
INSERT INTO `class_schedule` (`name`, `description`, `instructor_id`, `pool_type`, `start_time`, `end_time`, `date`, `capacity`) VALUES
('Aqua Fit', 'Energizing water-based workout for all fitness levels.', 1, 'Deep', '08:00', '09:00', '2024-05-01', 15),
('Low-Impact', 'Gentle aquatic exercise to strengthen and tone.', 2, 'Deep', '09:30', '10:30', '2024-05-02', 5),
('Mums', 'Fun and safe workout for pre and post-natal mothers.', 3, 'Deep', '11:00', '12:00', '2024-05-03', 7),
('Babies', 'Introduction to water for babies with their parents.', 4, 'Deep', '08:00', '09:00', '2024-05-04', 4),
('Zumba', 'Water Zumba class that feels more like a pool party.', 5, 'Deep', '09:30', '10:30', '2024-05-05', 3),
('Aqua Fit', 'Energizing water-based workout for all fitness levels.', 1, 'Deep', '11:00', '12:00', '2024-05-06', 2),
('Low-Impact', 'Gentle aquatic exercise to strengthen and tone.', 2, 'Deep', '08:00', '09:00', '2024-05-07', 9),
('Mums', 'Fun and safe workout for pre and post-natal mothers.', 3, 'Deep', '09:30', '10:30', '2024-05-08', 13),
('Babies', 'Introduction to water for babies with their parents.', 4, 'Deep', '11:00', '12:00', '2024-05-09', 12),
('Zumba', 'Water Zumba class that feels more like a pool party.', 5, 'Deep', '08:00', '09:00', '2024-05-10', 4),
('Aqua Fit', 'Energizing water-based workout for all fitness levels.', 1, 'Deep', '09:30', '10:30', '2024-05-11', 3),
('Low-Impact', 'Gentle aquatic exercise to strengthen and tone.', 2, 'Deep', '11:00', '12:00', '2024-05-12', 6),
('Mums', 'Fun and safe workout for pre and post-natal mothers.', 3, 'Deep', '08:00', '09:00', '2024-05-13', 8),
('Babies', 'Introduction to water for babies with their parents.', 4, 'Deep', '09:30', '10:30', '2024-05-14', 8),
('Zumba', 'Water Zumba class that feels more like a pool party.', 5, 'Deep', '11:00', '12:00', '2024-05-15', 15),
('Aqua Fit', 'Energizing water-based workout for all fitness levels.', 1, 'Deep', '08:00', '09:00', '2024-05-16', 15),
('Low-Impact', 'Gentle aquatic exercise to strengthen and tone.', 2, 'Deep', '09:30', '10:30', '2024-05-17', 15),
('Mums', 'Fun and safe workout for pre and post-natal mothers.', 3, 'Deep', '11:00', '12:00', '2024-05-18', 15),
('Babies', 'Introduction to water for babies with their parents.', 4, 'Deep', '08:00', '09:00', '2024-05-19', 15),
('Zumba', 'Water Zumba class that feels more like a pool party.', 5, 'Deep', '09:30', '10:30', '2024-05-20', 15);

INSERT INTO `lesson_schedule` (`instructor_id`, `description`, `start_time`, `end_time`, `date`, `lane_number`, `capacity`) VALUES
(1, 'Advanced swimming techniques for competitive swimmers.', '12:30', '13:30', '2024-05-01', 1, 1),
(2, 'Beginner swimming lessons focusing on basic strokes and water safety.', '14:00', '15:00', '2024-05-02', 2, 1),
(3, 'Intermediate swimming lessons to improve technique and endurance.', '12:30', '13:30', '2024-05-03', 3, 1),
(4, 'Personalized water aerobics session for fitness and rehabilitation.', '14:00', '15:00', '2024-05-04', 4, 1),
(5, 'One-on-one diving lessons focusing on techniques and safety.', '12:30', '13:30', '2024-05-05', 5, 1),
(1, 'Personalized training session for triathlon swimming preparation.', '14:00', '15:30', '2024-05-06', 6, 1), -- Extra 30 minutes
(2, 'Advanced breathing techniques for enhanced underwater performance.', '12:30', '13:30', '2024-05-07', 7, 1),
(3, 'Stroke refinement and efficiency training for competitive swimmers.', '14:00', '15:00', '2024-05-08', 8, 1),
(4, 'Underwater photography techniques and safety for divers.', '12:30', '13:30', '2024-05-09', 9, 1),
(5, 'Personalized open water swimming lessons for long-distance swimmers.', '14:00', '15:30', '2024-05-10', 10, 1), -- Extra 30 minutes
(1, 'Speed and agility drills for competitive swimmers.', '12:30', '13:30', '2024-05-11', 1, 1),
(2, 'Survival swimming techniques and safety training.', '14:00', '15:00', '2024-05-12', 2, 1),
(3, 'One-on-one synchronized swimming techniques for all levels.', '12:30', '13:30', '2024-05-13', 3, 1),
(4, 'Aquatic therapy sessions for rehabilitation and relaxation.', '14:00', '15:00', '2024-05-14', 4, 1),
(5, 'Tailored swim workouts for fitness enthusiasts.', '12:30', '13:30', '2024-05-15', 5, 1),
(1, 'Technique and tactics for open water racing.', '14:00', '15:00', '2024-05-16', 6, 1),
(2, 'Personal coaching for mastering the butterfly stroke.', '12:30', '13:30', '2024-05-17', 7, 1),
(3, 'Endurance training sessions for distance swimmers.', '14:00', '15:00', '2024-05-18', 8, 1),
(4, 'Customized workout plans for swimmers looking to lose weight.', '12:30', '13:30', '2024-05-19', 9, 1),
(5, 'Pre-competition nerves and mental preparation coaching.', '14:00', '15:00', '2024-05-20', 10, 1);
